...
public class DoctorsFragment extends Fragment {
    ...
    public static void expand(final View v, final android.android.shifa.ActivitiesAndFragments.DoctorsFragment.AnimListener animListener) {
    ...
    private void toggleSectionText(View view) {
        ...
        if (show) {
            expand(lyt_expand_text, new android.android.shifa.ActivitiesAndFragments.DoctorsFragment.AnimListener() {
                @Override
